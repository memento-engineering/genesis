...
/// seeds (`Stage`/`Box`/`Text`) mount as render elements that own their `Rect`
/// and paint into the double-buffered `CellGrid` as their artifact response —
/// the RenderObjectElement analog, taken literally. The stage element is the
/// RenderView analog and owns the scheduling glue: `BuildOwner.flush()` ->
/// flow relayout -> repaint exactly the dirty render elements' rects ->
...
export 'src/render_element.dart';
